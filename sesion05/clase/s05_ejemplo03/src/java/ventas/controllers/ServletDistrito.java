...
@WebServlet(name = "ServletDistrito", urlPatterns = {"/sDistrito"})
public class ServletDistrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String creditos = request.getParameter("txtCreditos");
        Distrito curso = new Distrito();
        curso.setCoddis(id);
        curso.setCodven(nombre);
        curso.setNomdis(creditos);
